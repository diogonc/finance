...
export class TransferComponent implements OnInit {
  ...
  save() {
    const fromAccount = this.accounts[this.transferVm.fromAccountIndex];
    const toAccount = this.accounts[this.transferVm.toAccountIndex];
    const creditCategory = this.categoryRepository.getCreditTransfer();
    const debitCategory = this.categoryRepository.getDebitTransfer();
